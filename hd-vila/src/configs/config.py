...
class SharedConfigs(object):
    ...
    def __init__(self, desc="shared config for pretraining and finetuning"):
        ...
        # debug parameters
        parser.add_argument(
            "--data_mount_dir", default="/data_mount", type=str,
            help="data mount dir")
        parser.add_argument(
        ...
        parser.add_argument("--mmdetection_weights_path", type=str,
                            help="path to cnn weights, only use for pretraining")
        ...
        parser.add_argument("--inference_model_step", default=-1,
        ...
        parser.add_argument("--img_aug", type=int, choices=[0, 1], default=0,
                            help="image augmentation. 0: disable, 1 enable")
        ...
        parser.add_argument('--deepspeed_config',
                            type=str,
                            default="src/configs/deepspeed_test.json",
                            help='local rank passed from distributed launcher')
