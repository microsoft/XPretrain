...
from src.models import LFVILA_Pretrain
...
def main():
    ...
    parser.add_argument('--config', default='./src/configs/pretrain_stage1.yaml')
    ...
    model = LFVILA_Pretrain(args, config)
    ...
    if config.stage==2:
        trainer.evaluate(dataloader_vals['PreTrainDataset-val'], stage=2, pretrain_val=True)
